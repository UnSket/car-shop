...
export const CarsTable: React.FC<CarsTableProps> = ({
    ...
    return (
        <div>
            ...
            <Typography variant="subtitle1" mt={1.5} mb={2}>
                Showing 10 of {data.totalCarsCount} cars
            </Typography>
            <div className={styles.content}>
                {data.cars.map((car) => (
                    <CarCard car={car} key={car.stockNumber} />
                ))}
            </div>
            <div className={styles.footer}>
                ...
                <Typography variant="body1">
                    Page {page} of {data.totalPageCount}
                </Typography>
                {hasNext && (
                    <>
                        <Button
                        ...
                        <Button
                            variant="text"
                            onClick={() => setPage(data.totalPageCount)}
                        >
                            Last
                        </Button>
                    </>
